...
print('Finish. Loss: {:.8f}, Accurate Rate: {:.8f}'.format(
    running_loss / (len(train_dataset)), running_acc / len(train_dataset)
))
...
print('Test Loss: {:.8f}, Accurate Rate: {:.8f}'.format(eval_loss / (len(
    test_dataset)), eval_acc / len(test_dataset)))

#  要识别的图片
input_image = './image/7_black.png'
